...
export const INVALID_ALL_CACHE = prefix('INVALID_ALL_CACHE')
export const INVALID_ALL_CACHE_COMPLETED = prefix('INVALID_ALL_CACHE_COMPLETED')
export const INVALID_ALL_CACHE_FAILED = prefix('INVALID_ALL_CACHE_FAILED')
